...
interface CreateEpicPageClientProps {
  projectId: string;
}

export default function CreateEpicPageClient({ projectId }: CreateEpicPageClientProps) {
    ...
    <section className="-mx-6 -mt-6 flex min-h-[calc(100svh-8rem)] flex-col overflow-x-hidden bg-[#F4F7FA] px-6 pb-16 pt-0">
      <div className="flex w-full flex-1 flex-col">
        <div className="mt-2 w-full shrink-0 text-left sm:mt-3">
          ...
          <h1 className="text-3xl font-bold leading-none tracking-tight text-[#11284d]">Create New Epic</h1>
