...
import { initialsFromName } from "../../shared/components/epic-details-utils";
  ...
  return (
    <div className="relative" ref={popoverRef}>
      {!open ? (
        ...
        <DropdownPanel className="top-0 z-10 max-h-56 overflow-y-auto rounded-lg py-1 ring-1 ring-slate-900/5">
          <DropdownOptionButton className="flex items-center gap-2" onClick={() => handlePick(null)}>
