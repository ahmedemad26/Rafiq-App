...
import type { TaskCardProps } from "@/lib/types/features/tasks/tasks-board-view";
import { formatDueDateShort } from "../utils/tasks-board-view.utils";
    ...
    >
      ...
      <div className="mt-2 sm:hidden">
        ...
        <select
          ...
          className={cn(
            "h-10 w-full appearance-none rounded-lg border border-slate-300 bg-white pl-3 pr-9 text-xs font-semibold tracking-[0.03em] text-slate-700 shadow-sm",
            "focus:border-[#7fa2e3] focus:outline-none focus:ring-2 focus:ring-[#d9e6ff]",
