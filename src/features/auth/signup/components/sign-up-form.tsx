...
import { PASSWORD_CHECKS, registerSchema, type RegisterValues } from "@/lib/schemes/register-schema";
    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} noValidate className="space-y-1">
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              <FormLabel className="text-xs font-semibold tracking-widest uppercase text-slate-mid">Name</FormLabel>
              <FormControl>
                <Input placeholder="Enter your full name" {...field} className="bg-surface-highest text-slate-dark" />
              </FormControl>
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Input placeholder="e.g. Project Manager" {...field} className="bg-surface-highest text-slate-dark" />
              </FormControl>
              <FormMessage className="text-xs" />
            </FormItem>
          )}
        ...
        <div className="flex gap-3">
          <FormField
            ...
            render={({ field }) => (
              <FormItem className="flex-1">
                ...
                <FormControl>
                  <Input type="password" placeholder="Min 8 chars" {...field} className="bg-surface-highest text-slate-dark" />
                </FormControl>
                <FormMessage className="text-xs" />
              </FormItem>
            )}
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem className="flex-1">
                <FormLabel className="text-xs font-semibold tracking-widest uppercase text-slate-mid">Confirm</FormLabel>
                <FormControl>
                  <Input type="password" placeholder="Repeat" {...field} className="bg-surface-highest text-slate-dark" />
                </FormControl>
                <FormMessage className="text-xs" />
              </FormItem>
            )}
